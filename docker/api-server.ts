// Standalone tRPC API server for the Docker stack: the extended electric-circuits surface
...
console.log(`electric-circuits API listening on ${server.url} (engine: ${engineUrl}, ds: ${dsUrl})`)
