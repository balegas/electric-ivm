// Standalone tRPC API server for the Docker stack: the extended electric-lite surface
...
console.log(`electric-lite API listening on ${server.url} (engine: ${engineUrl}, ds: ${dsUrl})`)
