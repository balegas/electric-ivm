...
// connection string is exported via ELECTRIC_LITE_TEST_PG_URL (inherited by forked workers).
...
export default function setup() {
  ...
  process.env.ELECTRIC_LITE_TEST_PG_URL = `postgres://postgres@127.0.0.1:${port}/postgres`
